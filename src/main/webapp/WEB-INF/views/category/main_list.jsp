...
<body>
		...
		<div class="wrap">	
			...
			<div class="list">
				...
				<div class="list_area">
					<c:forEach items="${main_list }" var="item">
						<div class="list_item"> 
							<div class="item_no">${item.kmc_seq}</div>
							<div class="item_name">${item.kmc_name }</div>
							<div class="item_reg_date">
								<fmt:formatDate value="${item.kmc_reg_date}" pattern="yyyy-MM-dd HH:mm" />
							</div>
